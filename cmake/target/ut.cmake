...
function(ut_add_ctest UT_EXECUTABLE_TARGET)
    ...
    get_target_property(UT_WORKING_DIRECTORY "${UT_EXECUTABLE_TARGET}" FPRIME_WORKING_DIRECTORY)
    if (NOT UT_WORKING_DIRECTORY)
        set(UT_WORKING_DIRECTORY "${CMAKE_CURRENT_SOURCE_DIR}")
    endif()
    add_test(NAME ${UT_EXECUTABLE_TARGET} COMMAND ${UT_EXECUTABLE_TARGET} WORKING_DIRECTORY "${UT_WORKING_DIRECTORY}")
