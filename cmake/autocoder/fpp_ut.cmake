...
function(fpp_ut_setup_autocode MODULE_NAME AC_INPUT_FILES)
    ...
    get_target_property(FPRIME_INTERFACE_INCLUDE_DIRS "${FPRIME_PROJECT_INTERFACE_TARGET}" INTERFACE_INCLUDE_DIRECTORIES)
    if (NOT FPRIME_INTERFACE_INCLUDE_DIRS)
        set(FPRIME_INTERFACE_INCLUDE_DIRS "")
    endif()
    string(REGEX REPLACE ";" ","  FPRIME_INCLUDE_DIRS_COMMA_SEP "${FPRIME_INTERFACE_INCLUDE_DIRS}")
