...
For status of the CI on those and other references, please see
https://github.com/nasa/fprime/actions. See the [F´ CI workflow
guide](https://github.com/nasa/fprime/blob/devel/.github/workflows/README.md)
for branch selection, overlays, and local reproduction.
