...
void ComQueueTester ::sendByQueueNumber(Fw::Buffer& buffer,
    ...
    if (queueNum < ComQueue::COM_PORT_COUNT) {
        ...
        invoke_to_comPacketQueueIn(portNum, comBuffer, ComCfg::Apid::FW_PACKET_UNKNOWN);
    } else {
        portNum = queueNum - ComQueue::COM_PORT_COUNT;
        queueType = QueueType::BUFFER_QUEUE;
        invoke_to_bufferQueueIn(portNum, buffer, ComCfg::Apid::FW_PACKET_UNKNOWN);
    }
}
...
void ComQueueTester ::testFIFOMode() {
    ...
    invoke_to_comPacketQueueIn(0, comBuffer1, ComCfg::Apid::FW_PACKET_UNKNOWN);
    invoke_to_comPacketQueueIn(0, comBuffer2, ComCfg::Apid::FW_PACKET_UNKNOWN);
    invoke_to_comPacketQueueIn(0, comBuffer3, ComCfg::Apid::FW_PACKET_UNKNOWN);
    dispatchAll();
...
void ComQueueTester ::testBufferQueueFIFOMode() {
    ...
    invoke_to_bufferQueueIn(0, buffer1, ComCfg::Apid::FW_PACKET_UNKNOWN);
    invoke_to_bufferQueueIn(0, buffer2, ComCfg::Apid::FW_PACKET_UNKNOWN);
    invoke_to_bufferQueueIn(0, buffer3, ComCfg::Apid::FW_PACKET_UNKNOWN);
    dispatchAll();
