...
It receives payload data (such as a Space Packet or Encapsulation Packet) on input and produces an AOS frame on its output port as a result. Please refer to the CCSDS [AOS specification (CCSDS 732.0-B-5)](https://ccsds.org/wp-content/uploads/gravity_forms/5-448e85c647331d9cbaf66c096458bdd5/2025/10/732x0b5ec1.pdf) for details on the frame format and protocol.
