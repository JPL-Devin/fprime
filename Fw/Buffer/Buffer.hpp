...
class Buffer : public Fw::Serializable {
  ...
  public:
    ...
    //! Serializes this buffer to a SerialBufferBase
    //!
    //! This serializes the buffer to a SerialBufferBase, however, it DOES NOT serialize the wrapped data. It only
    ...
    //! Deserializes this buffer from a SerialBufferBase
    //!
    //! This deserializes the buffer from a SerialBufferBase, however, it DOES NOT handle serialized data. It only
